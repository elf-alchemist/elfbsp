...
static_assert(sizeof(raw_linedef_doom_t) == 14, "Size mismatch for 'raw_linedef_t'. Should be 14.");
static_assert(sizeof(raw_linedef_hexen_t) == 16, "Size mismatch for 'raw_hexen_linedef_t'. Should be 16.");
static_assert(sizeof(raw_sidedef_doom_t) == 30, "Size mismatch for 'raw_sidedef_t'. Should be 30.");
static_assert(sizeof(raw_sector_doom_t) == 26, "Size mismatch for 'raw_sector_t'. Should be 26.");
static_assert(sizeof(raw_thing_doom_t) == 10, "Size mismatch for 'raw_thing_t'. Should be 10.");
static_assert(sizeof(raw_thing_hexen_t) == 20, "Size mismatch for 'raw_hexen_thing_t'. Should be 20.");
